...
class features:
    ...
    def strengthen(self, alpha = 10):
        ...
        gx = cv.Sobel(moon_f, cv.CV_64F, 1, 0, ksize=3)
        gy = cv.Sobel(moon_f, cv.CV_64F, 0, 1, ksize=3)
    ...
    def calcHist_CV(self, img, color):
            hist= cv2.calcHist_CV([img], [0], None, [256], [0.0,255.0])  
